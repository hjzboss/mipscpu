...
class Vjz_core_min_sopc VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vjz_core_min_sopc___024root* const rootp;
    ...
    explicit Vjz_core_min_sopc(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vjz_core_min_sopc(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vjz_core_min_sopc();
  private:
    VL_UNCOPYABLE(Vjz_core_min_sopc);  ///< Copying not allowed
